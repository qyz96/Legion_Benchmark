...
LAUNCHER="mpirun -n ${SLURM_NTASKS}" ~/legion/language/regent.py test_dgemm.rg -fflow 0 -level 5 -n ${MATRIX_SIZE} -p ${NUM_BLOCKS} -ll:csize 26384 -foverride-demand-index-launch 1 -ll:cpu ${NUM_CPUS} -ll:util ${NUM_CPUS}
